    ...
    <div class="sidebar" id="sidebar">
        <div>
            ...
            <div class="nav-links">
                ...
                <a href="{{ route('dokter.data-pasien') }}" class="{{ Request::routeIs('dokter.data-pasien') ? 'active' : '' }}">
        ...
        <div class="user-info-section">
            <span class="user-name">{{ Auth::user()->name ?? 'Dokter' }}</span>
            <form action="{{ route('dokter.logout') }}" method="POST" class="w-100">
                @csrf
