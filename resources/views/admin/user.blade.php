        ...
        <div class="card-header bg-white py-3">
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <div class="btn-group w-100 d-flex flex-wrap flex-md-nowrap" role="group" aria-label="User categories">
                        <a href="{{ route('admin.master.users', ['type' => 'user']) }}"
                           class="btn {{ $activeTab == 'user' ? 'btn-primary' : 'btn-outline-primary' }} fw-semibold flex-fill mb-2 mb-md-0">
                        ...
                        <a href="{{ route('admin.master.users', ['type' => 'dokter']) }}"
                           class="btn {{ $activeTab == 'dokter' ? 'btn-primary' : 'btn-outline-primary' }} fw-semibold flex-fill mb-2 mb-md-0">
                            <i class="fa-solid fa-user-md me-1"></i> 
                            <span class="d-none d-sm-inline">Dokter</span>
                            <span class="d-inline d-sm-none">Dokter</span>
                        </a>
                        <a href="{{ route('admin.master.users', ['type' => 'admin']) }}"
                           class="btn {{ $activeTab == 'admin' ? 'btn-primary' : 'btn-outline-primary' }} fw-semibold flex-fill mb-2 mb-md-0">
                ...
                <div class="col-12">
                    @if ($activeTab == 'dokter')
                        <button class="btn btn-success fw-semibold w-100 w-md-auto" data-bs-toggle="modal" data-bs-target="#addDokterModal">
                            <i class="fa-solid fa-plus me-1"></i> Tambah Dokter
                        </button>
                    @elseif ($activeTab == 'admin')
                        <button class="btn btn-success fw-semibold w-100 w-md-auto" data-bs-toggle="modal" data-bs-target="#addAdminModal">
        ...
        <div class="card-body bg-light">
            ...
            <div class="d-lg-none">
                @forelse ($data as $index => $item)
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <h6 class="fw-bold mb-0 text-primary">
                                    {{ $activeTab == 'user' ? $item->name : ($activeTab == 'dokter' ? $item->nama_dokter : $item->nama) }}
                                </h6>
                            ...
                            @if ($activeTab == 'user')
                                ...
                                <div class="mb-2">
                                    ...
                                    <span class="fw-medium">{{ $item->no_hp }}</span>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted d-block">Alamat</small>
                                    <span class="fw-medium">{{ $item->alamat }}</span>
                                </div>
                                <div class="mb-2">
                                    <small class="text-muted d-block">Tgl. Lahir</small>
                                    <span class="fw-medium">{{ \Carbon\Carbon::parse($item->tgl_lahir)->format('d M Y') }}</span>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-3">
                                    <small class="text-muted d-block">Tgl. Gabung</small>
                            ...
                            @elseif ($activeTab == 'dokter')
                                ...
                                <div class="d-grid gap-2">
                                    <button class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#ubahStatusModal{{ $item->id }}">
                                        <i class="fa-solid fa-rotate me-1"></i> Ubah Status
                                    </button>
                                    <button class="btn btn-info btn-sm text-white" data-bs-toggle="modal" data-bs-target="#resetPasswordModal{{ $item->id }}">
                                        <i class="fa-solid fa-lock-open me-1"></i> Reset Password
                                    </button>
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteDokterModal{{ $item->id }}">
                            ...
                            @elseif ($activeTab == 'admin')
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteAdminModal{{ $item->id }}">
                                        <i class="fa-solid fa-trash me-1"></i> Hapus Data
                                    </button>
                                </div>
                            @endif
                    ...
                    {{-- Modals for mobile (same as desktop) --}}
                    @if ($activeTab == 'dokter')
                        {{-- Modal Ubah Status --}}
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content border-0 shadow">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <p>
                                            Anda akan mereset password untuk dokter <strong>{{ $item->nama_dokter }}</strong> (<strong>Username: {{ $item->username }}</strong>).
                                        </p>
                                        <p class="mb-0">
                                            Password dokter akan diatur ulang dan disamakan dengan nilai <strong>Username</strong> saat ini. Mohon informasikan perubahan ini kepada dokter yang bersangkutan.
                                        </p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
